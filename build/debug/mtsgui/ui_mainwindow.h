...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        QIcon icon1;
        icon1.addFile(QString::fromUtf8(":/resources/open16.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon6;
        icon6.addFile(QString::fromUtf8(":/resources/about16.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionAbout->setIcon(icon6);
        actionSave = new QAction(MainWindow);
        actionSave->setObjectName(QString::fromUtf8("actionSave"));
        QIcon icon7;
        icon7.addFile(QString::fromUtf8(":/resources/save16.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionSave->setIcon(icon7);
        actionSaveAs = new QAction(MainWindow);
        actionSaveAs->setObjectName(QString::fromUtf8("actionSaveAs"));
        QIcon icon8;
        icon8.addFile(QString::fromUtf8(":/resources/saveas16.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/resources/import16.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon15;
        icon15.addFile(QString::fromUtf8(":/resources/help16.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionReferenceManual->setIcon(icon15);
        actionClose = new QAction(MainWindow);
        actionClose->setObjectName(QString::fromUtf8("actionClose"));
        QIcon icon16;
        icon16.addFile(QString::fromUtf8(":/resources/close16.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon17;
        icon17.addFile(QString::fromUtf8(":/resources/picture16.png"), QSize(), QIcon::Normal, QIcon::Off);
        ...
        QIcon icon19;
        icon19.addFile(QString::fromUtf8(":/resources/adjustsize16.png"), QSize(), QIcon::Normal, QIcon::Off);
